...
const slides = [
    {
        ...
        text: 'Embrace the gig economy and apply only for the shifts thah fit in your schedule. Receive updates and log hours all from the convenience of your phone',
        image: require('../../assets/images/group-291.png'),
    },
    {
        key: '2',
        title: 'Find new gigs',
        text: 'The app will automatically notify you when new jobs are posted in your area. Apply in few taps.',
        image: require('../../assets/images/ilust-2.png'),
    },
    {
        key: '3',
        title: 'Quick and transparent rates',
        text: 'View for each shift or job available near you.',
        image: require('../../assets/images/ilust-3.png'),
    },
];
